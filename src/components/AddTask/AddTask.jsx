...
const AddTask = (props) => {
  ...
  const [enteredDescription, setEnteredDescription] = useLocalStorage("description","");
  const [enteredDate, setEnteredDate] = useLocalStorage("date","");
  const [isPriority, setIsPriority] = useLocalStorage("isPriority",false);
